...
import { FaPython, FaDocker, FaLayerGroup, FaPeopleArrows } from 'react-icons/fa';
                ...
                <Route path="/" element={
                    <>
                        ...
                        <div className='Estudios'>
                            <h1>Estudios</h1>
                            <div className='UIS-Campus'>
                                <div className='UIS'>
                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTNJZFzfeHtCg_xSnNdh__SrzDFqLQFPigugg&s"/>
                                    <label className='estudiosLabel'>Fecha :</label><h3>2019-Actualidad</h3>
                                ...
                                <div className='Campus'>
                                    ...
                                    <label className='estudiosLabel'>Fecha :</label><h3>2024-Actualidad</h3>
                        ...
                        <div className='Experiencia_Container'>
                            ...
                            <div className='Experiencia'>
                                <Card 
                                    ...
                                    title="Excel" 
                                    description="Manejo de Macros y lenguaje VBA."
                                />
                                <Card 
                                    Icon={SiPowerbi} 
                                    title="Power BI" 
                                    description="Creación de KPIs en tiempo real y presentacion de datos."
                                />
                                <Card 
                                    Icon={SiRstudioide} 
                                    title="R Studio" 
                                    description="Lenguaje de programación para analisis de datos."
                                />
                            </div>
                        </div>
                        <Footer />
